/*The Diff Array technique is a powerful tool for efficiently performing range update queries on an array. It allows you to update a range of elements in constant time and then compute the final values with a single pass through the array.
--> Theory
